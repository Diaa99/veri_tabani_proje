          ...
          <h1>Products</h1>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="Enter Product Name" value="<?php echo $final['title'] ?>" name="name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="picture" name="file" value="<?php echo $final['image'] ?>">
                </div>
                <div class="form-group">
